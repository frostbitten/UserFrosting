...
$(function() {
    $(window).bind("load resize", function() {
        ...
        oheight = ((this.window.innerHeight > 0) ? this.window.innerHeight : this.screen.height) - 1;
        height = oheight - topOffset;
		$('.sidebar-nav').css('max-height',$(window).height()-$('.sidebar-nav').position().top);
